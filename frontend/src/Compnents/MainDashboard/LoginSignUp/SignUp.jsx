...
const SignUp = ({handleAuthentication ,  handleLogInPageVisibilty }) => {
  return (
    <div className="h-screen  bg-gray-800 font-sans">
      <div className="w-[80%] flex mx-auto h-full">
        <div className="w-full  mx-auto  bg-white">
          ...
          >
            ...
            <input
              ...
              className="h-10 bg-gray-100 px-3 text-sm rounded-2xl w-full outline-none placeholder:text-gray-400 font-semibold"
            />
            <button onClick={handleAuthentication} className="h-10 bg-gray-600 text-white hover:bg-gray-800 duration-300 px-3 text-sm rounded-2xl w-full font-semibold">
              Signup
            </button>
          </form>
          <div className="py-4">
        ...
        >
          ...
          <button
            onClick={handleLogInPageVisibilty}
            className="w-[200px] font-semibold bg-white text-teal-700 ml-24 rounded-full h-12 text-sm "
          >
            Login
          </button>
        </div>
